...
void	img_init(t_game *game)
{
	...
	game->imgs[1].img = mlx_xpm_file_to_image(game->mlx, "../texture/rock.xpm", &game->imgs[1].width, &game->imgs[1].height);
	game->imgs[2].img = mlx_xpm_file_to_image(game->mlx, "../texture/collective.xpm", &game->imgs[2].width, &game->imgs[2].height);
}
